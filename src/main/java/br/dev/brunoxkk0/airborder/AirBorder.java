...
import br.dev.brunoxkk0.airborder.proxy.CommonProxy;
...
public class AirBorder {
    ...
    @SidedProxy(clientSide = "br.dev.brunoxkk0.airborder.proxy.ClientProxy", serverSide = "br.dev.brunoxkk0.airborder.proxy.CommonProxy")
